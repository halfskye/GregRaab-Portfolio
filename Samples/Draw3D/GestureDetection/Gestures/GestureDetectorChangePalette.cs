...
{
    public class GestureDetectorChangePalette : BaseGestureDetectorDraw3D
    {
        [Header("Change Palette")]
        ...
        {
            return _state == State.CHANGE_PALETTE;
        }
        ...
        {
            // DebugLogUtilities.LogError(DebugLogUtilities.DebugLogType.DRAW_3D, "Change Palette - INITIATED");
        ...
        private void OnDetectStartFinalize()
        {
            ...
            {
                // DebugLogUtilities.LogError(DebugLogUtilities.DebugLogType.DRAW_3D, "Change Palette - FINALIZED");

                _state = State.CHANGE_PALETTE;
            }
        }
